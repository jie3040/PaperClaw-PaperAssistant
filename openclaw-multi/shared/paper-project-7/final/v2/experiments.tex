...
\hline
\textbf{Sample} & \textbf{Class} & \textbf{Load} & \textbf{Damage} & \textbf{Sample} & \textbf{Training} & \textbf{Testing} \\
 & & \textbf{(HP)} & \textbf{Dia.(in)} & \textbf{Length} & \textbf{Set} & \textbf{Set} \\ \hline
...
\begin{tabular}{ccccccc}
\hline
\textbf{Sample} & \textbf{Class} & \textbf{Damage} & \textbf{Dia.(in)} & \textbf{Sample} & \textbf{Training} & \textbf{Testing} \\
 & & & & \textbf{Length} & \textbf{Set} & \textbf{Set} \\ \hline
...
\hline
\textbf{Case} & \textbf{Criterion} & \textbf{0} & \textbf{1} & \textbf{2} & \textbf{3} & \textbf{4} & \textbf{5} & \textbf{6} & \textbf{7} & \textbf{8} \\ \hline
I & Sliding Window & 0.928 & 0.922 & 0.971 & 0.946 & 0.924 & 0.941 & 0.930 & 0.929 & 0.925 \\
I & Frequency based & 0.903 & 0.880 & 0.914 & 0.873 & 0.917 & 0.915 & 0.914 & 0.907 & 0.898 \\
II & Sliding Window & 0.913 & 0.911 & 0.945 & 0.911 & 0.925 & 0.934 & --- & --- & --- \\
II & Frequency based & 0.863 & 0.878 & 0.864 & 0.896 & 0.901 & 0.873 & --- & --- & --- \\
\hline
\end{tabular}
\end{table*}
...
In this subsection, we evaluate the impact of data augmentation on the multiclass fault diagnosis performance for the CWRU bearing dataset. We focus on the SVM classifier \cite{widodo2007svm_machine}'s accuracy as the dataset is transformed from a highly imbalanced state to a perfectly balanced one.
...
\label{tab:aug_strategy}
\begin{tabular}{lccccccc}
\hline
\textbf{Added samples} & 0 & 5 & 45 & 245 & 495 & 995 \\
\textbf{Minority class size} & 5 & 10 & 50 & 250 & 500 & 1000 \\
\textbf{Balance Ratio} & 0.005 & 0.01 & 0.05 & 0.25 & 0.5 & 1 \\
\hline
\end{tabular}
\end{table}
...
\begin{table*}[!t]
\centering
\caption{Classification Accuracy (\%) for Multiclass Fault Diagnosis for Case I}
\label{tab:acc_case1}
\begin{tabular}{lcccccccccccc}
\hline
 & \multicolumn{6}{c}{\textbf{Sliding Window Sampling}} & \multicolumn{6}{c}{\textbf{Frequency-based Selection}} \\
\textbf{Model} & \multicolumn{6}{c}{\textbf{Balance Ratio (BR)}} & \multicolumn{6}{c}{\textbf{Balance Ratio (BR)}} \\
 & 0.005 & 0.01 & 0.05 & 0.25 & 0.5 & 1 & 0.005 & 0.01 & 0.05 & 0.25 & 0.5 & 1 \\ \hline
...
\label{tab:aug_single}
\begin{tabular}{lccccc}
\hline
\textbf{Added samples} & 0 & 45 & 245 & 495 & 995 \\
\textbf{Minority class size} & 5 & 50 & 250 & 500 & 1000 \\
\textbf{Balance Ratio} & 0.005 & 0.05 & 0.25 & 0.5 & 1 \\
\hline
\end{tabular}
\end{table}
...
\begin{table*}[!t]
\centering
\caption{Classification Accuracy (\%) for Multiclass Fault Diagnosis for Case II}
\label{tab:acc_case2}
\begin{tabular}{lcccccccccccc}
\hline
 & \multicolumn{6}{c}{\textbf{Sliding Window Sampling}} & \multicolumn{6}{c}{\textbf{Frequency-based Selection}} \\
...
Finally, we conduct an ablation study \cite{shao2017deep_autoencoder} to quantify the contribution of each component in the CAC-CycleGAN-WGP framework. We evaluate the diagnostic accuracy on Case I underfour simplified configurations:
\begin{enumerate}
