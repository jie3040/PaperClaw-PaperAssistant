...
\begin{enumerate}
    ...
    \item \textbf{Fault Diagnosis (SVM \cite{vapnik1995smt}):} The high-quality synthetic samples are merged with the original imbalanced training set to form a balanced/augmented dataset. A Support Vector Machine (SVM) classifier is trained on this augmented set and validated on a separate, real-world test set.
\end{enumerate}
