# Figures Plan: CMSA-Trans (Project 8)
...
| **Fig. 9** | Parameter Sensitivity: Embedding Dimension | Data Plot | Single-Column | Bar or line chart evaluating how the dimension of the semantic space affects the final diagnosis accuracy. |
