# Tables Spec: CMSA-Trans (Project 8)
...
| **Table 7** | Similarity Metrics of Multi-Modal Embedding | Metric Type, Before Alignment, After Alignment | Metrics: Cosine Similarity, Euclidean Distance, KL-Divergence between signal and text features. | Single-Column, additional statistical validation. |
