# Data Plots Spec: CMSA-Trans (Project 8) - v2
...
| **Fig. 10** | Parameter Sensitivity: Embedding Dimension | Bar Chart | X-axis: Dimension Size (e.g., 64, 128, 256, 512, 1024). Y-axis: Unseen Task Accuracy (%). | Grouped bars by dataset (CWRU vs. SEU). Colors matching industrial blue/green scheme. |
| **Fig. 11** | Accuracy Comparison (Boxplots) | Boxplot | Statistical distribution of accuracy over 50 random seen/unseen category splits. | Median line and outliers indicated. |
