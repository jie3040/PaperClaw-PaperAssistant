# Data Plots Specification (v2)

## Fig.6: t-SNE Visualization (Experiments 4.4)
...
## Fig.7: Interpolation Coefficient Sensitivity (Experiments 4.4)
- **Type**: Line plot
...
## Fig.8: Training Convergence (Experiments 4.4)
