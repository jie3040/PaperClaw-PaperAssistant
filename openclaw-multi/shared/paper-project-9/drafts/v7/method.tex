...
Hard negative mining is employed using in-batch, memory queue, and augmentation-based strategies to select challenging examples, improving zero-shot accuracy by 6.5\%.
...
The optimal $\tau=0.07$ balances clustering sharpness and generalization, achieving 92.1\% on CWRU and 88.3\% on Paderborn.
