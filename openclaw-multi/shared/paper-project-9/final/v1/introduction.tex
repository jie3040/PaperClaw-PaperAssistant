...
\caption{The overall pipeline of the VibSemAlign framework for zero-shot cross-domain fault diagnosis via vibration-semantic alignment.}
\label{fig:1}
\end{figure*}
